// To run this script:
// deno run --allow-read --allow-write --allow-run --allow-net --allow-env --allow-ffi custom_file_handler.ts
...
async function myFileHandler(myUrl: URL) {
  ...
  if (myUrl.pathname === "/assets/webinix.jpeg") {
    return await getFile("image/jpeg", "assets/webinix.jpeg");
  }
  // Error 404 example
