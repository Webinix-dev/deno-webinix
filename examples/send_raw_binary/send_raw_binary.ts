...
import { Webinix } from "jsr:@webinix/deno-webinix@2.5.6"; // import {Webinix} from "https://deno.land/x/webinix@2.5.6/mod.ts";

const myHtml = `<!DOCTYPE html>
<html>
  <head>
    <script src="webinix.js"></script>
      <title>Webinix 2 - Deno Send Raw Binary Example</title>
    <style>
      body {
    ...
    <body>
        <h1>Webinix 2 - Deno Send Raw Binary Example</h1>
        <br>
...
function get_raw_data(e: Webinix.Event) {
...
async function get_raw_picture(e: Webinix.Event) {
  const pictureRaw = await Deno.readFile("./webinix.jpeg");
