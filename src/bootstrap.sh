...
if [[ "$1" == "" ]]; then
    ...
    # Release
    LINUX_ARM="https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-linux-gcc-arm.zip"
    LINUX_ARM64="https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-linux-gcc-arm64.zip"
    LINUX_X64="https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-linux-gcc-x64.zip"
    MACOS_ARM64="https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-macos-clang-arm64.zip"
    MACOS_X64="https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-macos-clang-x64.zip"
    WINDOWS_MSVC_X64="https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-windows-msvc-x64.zip"
...
if [[ "$1" == "minimal" ]]; then
    ...
    # Release
    BASE_URL="https://github.com/webinix-dev/webinix/releases/download/2.4.2/"
