...
:: Release
SET "LINUX_ARM=https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-linux-gcc-arm.zip"
SET "LINUX_ARM64=https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-linux-gcc-arm64.zip"
SET "LINUX_X64=https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-linux-gcc-x64.zip"
SET "MACOS_ARM64=https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-macos-clang-arm64.zip"
SET "MACOS_X64=https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-macos-clang-x64.zip"
SET "WINDOWS_MSVC_X64=https://github.com/webinix-dev/webinix/releases/download/2.4.2/webinix-windows-msvc-x64.zip"
...
SET "BASE_URL=https://github.com/webinix-dev/webinix/releases/download/2.4.2/"
